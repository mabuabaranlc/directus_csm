...
/// Service for managing file folders
/// Mirrors api/src/services/folders.ts
...
impl FoldersService {
    pub fn new(ctx: ServiceContext) -> Self {
        let items = ItemsService::new("directus_folders", ctx.clone());
        Self { ctx, items }
    }
    ...
    pub async fn delete_one(&self, pk: &PrimaryKey) -> Result<PrimaryKey, ServiceError> {
        // TODO: Handle cascading delete of files in folder
