...
/// Service for managing dashboard panels (widgets)
/// Mirrors api/src/services/panels.ts
pub struct PanelsService {
...
impl PanelsService {
    pub fn new(ctx: ServiceContext) -> Self {
        let items = ItemsService::new("directus_panels", ctx.clone());
        Self { ctx, items }
    }
